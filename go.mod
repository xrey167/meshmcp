...
// NetBird requires its own forks of these dependencies; every embedder
// must carry these replace directives (copied from caddy-netbird).
replace (
	...
	golang.zx2c4.com/wireguard => github.com/netbirdio/wireguard-go v0.0.0-20260523085312-4b4a4e36017f
)
