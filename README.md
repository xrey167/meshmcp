...
- **[docs/AIR-STEER.md](docs/AIR-STEER.md)** — Air · **Steer** build spec: send to / cancel / nudge / broadcast an agent, session, or task, and launch new agents/workflows — four code-ready primitives grounded in server→client MCP notify/request, `tasks/cancel`, and the drop-receiver pattern.
